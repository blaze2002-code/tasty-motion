        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">FoodieHub</span>
            </div>
            <p className="text-gray-400 mb-4">
              Bringing the best food directly to your doorstep. Fast delivery, great prices, and wide selection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 text-food-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">support@foodiehub.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 text-food-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
